...
describe('Cart', () => {
    ...
    beforeEach(() => {
        ...
        book1 = new Book('The Great Gatsby', 'F. Scott Fitzgerald', '1234567890', 10.99, true);
    ...
    it('should not add unavailable books to the cart', () => {
        const unavailableBook = new Book('To Kill a Mockingbird', 'Harper Lee', '3456789012', 12.99, false);
